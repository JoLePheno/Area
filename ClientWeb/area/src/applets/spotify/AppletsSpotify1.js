...
class AppletsSpotify1 extends Component {
    constructor() {
        super();
    ...
    addApplets(e) {
        ...
        Axios({
            ...
            .then(function (response) {
                ...
                const action = { type: "SPOTIFY1", value: response.data.id }
    ...
    removeApplets(e) {
        const query = "http://localhost:3000/api/areas/" + this.props.AppletsSpotify1Id;
    ...
    _handleChange(e) {
        ...
        if (this.props.switchValue.spotifyApplets1 === true) {
            this.removeApplets()
        } else {
            this.addApplets()
        }
            ...
            <div>
                <Card shadow={0} style={{width: '100%', height: '7%', background: '#1ED760'}}>
                    ...
                    <CardActions border style={{
                        ...
                        <Switch checked={this.props.switchValue.spotifyApplets1} ripple id="spotifyApplets1"
...
const mapStateToProps = (state) => {
    return {
        ...
        AppletsSpotify1Id: state.AppletsSpotify1Id
    }
}
export default connect(mapStateToProps)(AppletsSpotify1)

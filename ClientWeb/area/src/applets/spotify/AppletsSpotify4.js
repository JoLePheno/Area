...
class AppletsSpotify4 extends Component {
    constructor() {
        super();
    ...
    addApplets(e) {
        ...
        Axios({
            ...
            .then(function (response) {
                ...
                const action = { type: "SPOTIFY4", value: response.data.id }
    ...
    removeApplets(e) {
        const query = "http://localhost:3000/api/areas/" + this.props.AppletsSpotify4Id;
    ...
    _handleChange(e) {
        ...
        if (this.props.switchValue.spotifyApplets4 === true) {
            this.removeApplets()
        } else {
            this.addApplets()
        }
            ...
            <div>
                <Card shadow={0} style={{width: '100%', height: '7%', background: '#1ED760'}}>
                    ...
                    <CardActions border style={{
                        ...
                        <Switch checked={this.props.switchValue.spotifyApplets4} ripple id="spotifyApplets4"
...
const mapStateToProps = (state) => {
    return {
        ...
        AppletsSpotify4Id: state.AppletsSpotify4Id
    }
}
export default connect(mapStateToProps)(AppletsSpotify4)

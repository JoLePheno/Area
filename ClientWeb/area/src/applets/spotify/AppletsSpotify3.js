...
class AppletsSpotify3 extends Component {
    constructor() {
        super();
    ...
    addApplets(e) {
        ...
        Axios({
            ...
            .then(function (response) {
                ...
                const action = { type: "SPOTIFY3", value: response.data.id }
    ...
    removeApplets(e) {
        const query = "http://localhost:3000/api/areas/" + this.props.AppletsSpotify3Id;
    ...
    _handleChange(e) {
        ...
        if (this.props.switchValue.spotifyApplets3 === true) {
            this.removeApplets()
        } else {
            this.addApplets()
        }
                ...
                <Card shadow={0} style={{width: '100%', height: '7%', background: '#1ED760'}}>
                    <CardTitle expand style={{alignItems: 'flex-start', color: '#fff'}}>
                        <h6 style={{marginTop: '0'}}>
                            ...
                            Detail: Get your top song of the week<br/>
                        </h6>
                    </CardTitle>
                    <CardActions border style={{
                        ...
                        <Switch checked={this.props.switchValue.spotifyApplets3} ripple id="spotifyApplets3"
...
const mapStateToProps = (state) => {
    return {
        ...
        AppletsSpotify3Id: state.AppletsSpotify3Id
    }
}
export default connect(mapStateToProps)(AppletsSpotify3)

...
class AppletsMeteo3 extends Component {
    constructor() {
        super();
    ...
    addApplets(e) {
        ...
        Axios({
            ...
            .then(function (response) {
                ...
                const action = { type: "METEO3", value: response.data.id }
    ...
    removeApplets(e) {
        const query = "http://localhost:3000/api/areas/" + this.props.AppletsMeteo3Id;
    ...
    _handleChange(e) {
        ...
        if (this.props.switchValue.meteoApplets3 === true) {
            this.removeApplets()
        } else {
            this.addApplets()
        }
                ...
                <Card shadow={0} style={{width: '100%', height: '7%', background: '#FFCC33'}}>
                    <CardTitle expand style={{alignItems: 'flex-start', color: '#fff'}}>
                        <h6 style={{marginTop: '0'}}>
                            ...
                            Detail: Notify the weather of your city<br/>
                        </h6>
                    </CardTitle>
                    <Textfield
                    ...
                    <CardActions border style={{
                        ...
                        <Switch checked={this.props.switchValue.meteoApplets3} ripple id="meteoApplets3" onChange={this._handleChange}>Turn On/Off</Switch>
...
const mapStateToProps = (state) => {
    return {
        ...
        AppletsMeteo3Id: state.AppletsMeteo3Id,
        meteoApplets3: state.meteoApplets3
    }
}
export default connect(mapStateToProps)(AppletsMeteo3)

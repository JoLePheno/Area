...
class AppletsSteam1 extends Component {
    constructor() {
        super();
    ...
    addApplets(e) {
       ...
       Axios({
            ...
            .then(function (response) {
               ...
               const action = { type: "STEAM", value: response.data.id }
    ...
    removeApplets(e) {
        const query = "http://localhost:3000/api/areas/" + this.props.AppletsSteam1Id;
    ...
    _handleChange(e) {
        ...
        if (this.props.switchValue.steamApplets1 === true) {
           this.removeApplets()
        } else {
           this.addApplets()
        }
                ...
                <Card shadow={0} style={{width: '100%', height: '7%', background: '#061D51'}}>
                    <CardTitle expand style={{alignItems: 'flex-start', color: '#fff'}}>
                        <h6 style={{marginTop: '0'}}>
                            ...
                            Detail: Notify when a steam games have a new price<br/>
                        </h6>
                    </CardTitle>
                    <CardActions border style={{
                        ...
                        <Switch checked={this.props.switchValue.steamApplets1} ripple id="steamApplets1" onChange={this._handleChange}>Turn On/Off</Switch>
...
const mapStateToProps = (state) => {
    return {
        ...
        AppletsSteam1Id: state.AppletsSteam1Id
    }
}
export default connect(mapStateToProps)(AppletsSteam1)
